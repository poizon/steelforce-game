...
class Game {
  ...
  constructor() {
    this.init().catch(error => {
      ...
      this.showErrorScreen('Не удалось загрузить игру. Пожалуйста, обновите страницу.');
    });
  }
      ...
      bundles: [
        {
          name: 'common',
          assets: [
            { alias: 'font-main', src: 'assets/fonts/PressStart2P.ttf', loadType: 'font' as const },
          ],
        },
        {
          name: 'menu',
          assets: [
            ...
            { alias: 'btn-start-hover', src: 'assets/sprites/btn-start-hover.png' },
          ],
        },
        {
          name: 'news',
        ...
        },
        {
          name: 'rooftop',
          assets: [
            { alias: 'rooftop-background', src: 'assets/backgrounds/rooftop-bg.png' },
